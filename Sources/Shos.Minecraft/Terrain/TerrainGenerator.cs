namespace Shos.Minecraft.Terrain
{
    ...
    public static class TerrainGenerator
    {
        ...
        private const byte BlockAir = 0;
        private const byte BlockDirt = 1;
        private const byte BlockGrass = 2;
        private const byte BlockStone = 3;
        private const byte BlockWater = 8;
        private const byte BlockSand = 9;
        ...
        private static int CalculateSurfaceHeight(PerlinNoise2D noise, int worldX, int worldZ)
        {
        ...
        private static byte DetermineBlockId(int y, int surfaceY)
        {
            if (y > surfaceY)
            {
